      ...
      <div className="max-w-[var(--content-max-width)] mx-auto px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            />
            <span className="text-sm tracking-wide text-accent">5-Step Framework</span>
          </motion.div>
        ...
        <div className="relative max-w-6xl mx-auto">
          <WavyTimeline pathLength={pathLength} scrollProgress={smoothProgress} />
        </div>
      </div>
    </section>
  );
...
function WavyTimeline({ pathLength, scrollProgress }: { pathLength: any; scrollProgress: any }) {
  ...
  return (
    <div className="relative" style={{ minHeight: `${processSteps.length * 280 + 200}px` }}>
      {/* SVG Path */}
      <svg
        ref={svgRef}
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              border: isRevealed ? '1px solid var(--glass-border)' : '1px solid transparent',
            ...
            {isRevealed && (
              <>
                ...
                <motion.div
                  ...
                  style={{
                    background: 'linear-gradient(315deg, rgba(139, 92, 246, 0.3), transparent)',
                  }}
                  initial={{ opacity: 0, scale: 0 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 0.6, delay: 0.3 }}
